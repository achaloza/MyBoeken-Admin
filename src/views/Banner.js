    ...
    render() {
        ...
        const tableColumns = [
            ...
            },
            {
                ...
                Cell: row => (
                    <div style={{ justifyContent: "right" }}>{row.original.customer}</div>
                    )
            ...
            },
            {
                ...
                maxWidth: 100,
                Cell: row =>
                    dateFormat(new Date(row.original.date), "mm/dd/yyyy"),
                className: "text-center"
            },
            {
                Header: "Actions",
        ...
        return (
            <Container fluid className="main-content-container px-4 pb-4">
                <Row noGutters className="page-header py-4">
                    <PageTitle title="User List" subtitle="Dashboards" className="text-sm-left mb-3" />
                    <Col sm="2" className="d-flex ml-auto my-auto">
                        <Link to="/createuser" className="bg-primary rounded p-2"
                            style={{ boxShadow: "inset 0 0 5px rgba(0,0,0,.2)", color: "#fff" }}>Create Account</Link>
                    </Col>
                </Row>
                <Card className="p-0">
