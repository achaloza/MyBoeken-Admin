...
class AttributeList extends React.Component {
     ...
     */
    handleItemEdit(row) {
        this.props.history.push({ pathname: '/editattribute/' + row.original.id });
    }
        ...
        return (
            <Container fluid className="main-content-container px-4 pb-4">
                <Row noGutters className="page-header py-4">
                    <PageTitle title="Attributes" subtitle="Catelog" className="text-sm-left mb-3" />
                    <Col sm="2" className="d-flex ml-auto my-auto justify-content-end">
                        <Link to="/createattribute" className="bg-primary rounded p-2"
