...
import { Container, Row, Col, ButtonGroup, Button, Card, CardHeader, CardBody, FormSelect, InputGroup, InputGroupAddon, InputGroupText, FormInput, CardFooter } from "shards-react";
...
import CustomerView from '../customer-account/CustomerView';
import './model.css'

class CreateAccountList extends React.Component {
    constructor(props) {
        super(props);
    ...
    async componentWillMount() {
        ...
        this.searcher = new FuzzySearch(tableData, ["name", "default_address", "email", "phone"], {
            caseSensitive: false
        });
    }
        ...
        return (
            <Container fluid className="main-content-container px-4 pb-4">
                <Row noGutters className="page-header py-4">
                    <PageTitle title="Cutomers" subtitle="User & Customer" className="text-sm-left mb-3" />
...
export default withRouter(CreateAccountList);
