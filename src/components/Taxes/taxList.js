...
import getTransactionHistoryData from "../../data/banner-data";
...
class TaxList extends React.Component {
   ...
   */
  handleItemEdit(row) {
    this.props.history.push({ pathname: "/edittaxes/" + row.original.id });
  }
      ...
      },
      {
        ...
        Cell: row => (
          <div style={{ justifyContent: "right" }}>
            <img src={require(row.original.firstname)}></img>
          </div>
        )
      },
      {
      ...
      },
      {
        ...
        Cell: row => (
          <ButtonGroup size="sm" className="d-table mx-auto">
            <Button
              theme="white"
              onClick={() => this.handleItemConfirm(row)}
              title="Active and Deactive"
            >
              <i className="material-icons">&#xE5CA;</i>
            </Button>
            <Button
              theme="white"
              onClick={() => this.handleItemEdit(row)}
              title="Edit"
            >
              <i className="material-icons">&#xE254;</i>
            </Button>
