...
class Sessions extends React.Component {
  constructor(props) {
    ...
    this.getdummyservices();
  }
  // reduxcall=()=>{
  //   let data=[{id:1,name:"Ganesh"}]
  //   this.props.TestReduxUpdate(data);
  // }
  getdummyservices=async()=>{
    let dummyData = await dummyServices.userReg();
  ...
  render() {
    ...
    return (
      <Card small className="h-100">
       ...
       {/* <div style= {{backgroundColor:'red'}} onClick={()=>{this.reduxcall()}}>Ganesh</div>
       {console.log("test data: ",this.props.TestRedux[0])} */}
...
const mapDispatchToProps = (dispatch)=>{
  return {
    TestReduxUpdate: (product) => dispatch({ type: 'Text_Redux', payload: product }),
    }
}
